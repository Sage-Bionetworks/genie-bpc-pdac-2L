...
These are shown below, with little difference in survival based on genomics.  These cohorts are built in the same way as the main analysis, just skipping the KRAS G12D+ requirement.
...
- There is little difference between the genomic groups for baseline overall survival.
